...
```
cd existing_repo
git remote add origin https://training-git.lohika.com/cap-python-internship/python-internship-poland/mateusz-kuczynski.git
git branch -M main
...
- [ ] [Set up project integrations](https://training-git.lohika.com/cap-python-internship/python-internship-poland/mateusz-kuczynski/-/settings/integrations)
